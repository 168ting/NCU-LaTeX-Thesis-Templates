...
%%% 封面字體大小 %%%   {⟨大小⟩}{⟨行距⟩}
\def\fsUniversity{\fontsize{26}{31}\selectfont } % 校名字體大小
\def\fsTitle{\fontsize{22}{26.4}\selectfont } % 系所、論文標題、中文英文題目、國名
\def\fsNames{\fs{22}[1.5] } % 研究生姓名、指導教授等字體大小
...
\begin{titlepage}
    ...
    \begin{center}
        ...
        {\fsTitle  \makebox[\textwidth][c]{%
         永\hspace{0.4em}續\hspace{0.4em}與\hspace{0.4em}綠\hspace{0.4em}能\hspace{0.4em}科\hspace{0.4em}技\hspace{0.4em}碩\hspace{0.4em}士\hspace{0.4em}學\hspace{0.4em}位\hspace{0.4em}學\hspace{0.4em}程%
        }\par}
        
        {\fsTitle 碩\quad 士\quad 論\quad 文\par}
        \vspace*{20mm}
